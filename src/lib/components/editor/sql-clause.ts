...
export const CLAUSE_KEYWORDS: Record<SqlClause, string[]> = {
  'statement-start': [
    ...
    'truncate', 'explain', 'vacuum', 'analyze', 'set', 'show', 'begin',
    'commit', 'rollback', 'grant', 'revoke', 'copy', 'call', 'do', 'refresh',
    'reindex', 'reset', 'values',
  ],
  select: [
    'from', 'where', 'group', 'having', 'order', 'limit', 'offset', 'as',
    'distinct', 'all', 'union', 'intersect', 'except', 'case', 'when', 'and',
    'or', 'not', 'in', 'is', 'null', 'like', 'ilike', 'between', 'exists',
    'any', 'some', 'cast', 'fetch', 'for', 'window', 'over',
  ],
  from: [
    'where', 'join', 'left', 'right', 'full', 'inner', 'outer', 'cross',
    'natural', 'lateral', 'on', 'using', 'as', 'group', 'having', 'order',
    'limit', 'offset', 'union', 'intersect', 'except', 'tablesample',
  ],
  join: ['on', 'using', 'as', 'and', 'or', 'where', 'group', 'having', 'order', 'limit'],
  on: ['and', 'or', 'not', 'in', 'is', 'null', 'between', 'like', 'ilike', 'case'],
  where: [
    'and', 'or', 'not', 'in', 'is', 'null', 'like', 'ilike', 'similar',
    'between', 'exists', 'any', 'all', 'some', 'case', 'cast',
    'group', 'having', 'order', 'limit', 'offset', 'union', 'intersect',
    'except',
  ],
  'group-by': ['having', 'order', 'limit', 'offset', 'union', 'intersect', 'except', 'asc', 'desc', 'nulls'],
  having: ['and', 'or', 'not', 'in', 'is', 'null', 'like', 'ilike', 'between', 'exists', 'any', 'all', 'some', 'case', 'cast', 'order', 'limit', 'offset'],
  'order-by': ['asc', 'desc', 'nulls', 'first', 'last', 'limit', 'offset', 'fetch', 'collate', 'case', 'using'],
  limit: ['offset', 'fetch', 'for'],
  case: ['when', 'then', 'else', 'end', 'case'],
  'case-when': ['then', 'else', 'end', 'and', 'or', 'not', 'in', 'is', 'null', 'like', 'ilike', 'between', 'exists', 'any', 'all', 'some'],
